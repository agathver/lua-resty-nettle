...
local poly1305 = setmetatable({}, {
    __call = function(_, key, nonce, data, len)
        local context = ffi_new(context.poly1395_aes)
        ...
        lib.nettle_poly1305_aes_digest(context, 16, types.uint8_t_128)
...
function poly1305:digest()
    lib.nettle_poly1305_aes_digest(self.context, 16, types.uint8_t_128)
    return ffi_str(types.uint8_t_128, 16)
end
