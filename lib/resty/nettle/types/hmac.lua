...
local md5       = ffi_typeof "struct hmac_md5_ctx { struct md5_ctx outer; struct md5_ctx inner; struct md5_ctx state; }"
local ripemd160 = ffi_typeof "struct hmac_ripemd160_ctx { struct ripemd160_ctx outer; struct ripemd160_ctx inner; struct ripemd160_ctx state; }"
local sha1      = ffi_typeof "struct hmac_sha1_ctx { struct sha1_ctx outer; struct sha1_ctx inner; struct sha1_ctx state; }"
local sha256    = ffi_typeof "struct hmac_sha256_ctx { struct sha256_ctx outer; struct sha256_ctx inner; struct sha256_ctx state; }"
local sha512    = ffi_typeof "struct hmac_sha512_ctx { struct sha512_ctx outer; struct sha512_ctx inner; struct sha512_ctx state; }"
